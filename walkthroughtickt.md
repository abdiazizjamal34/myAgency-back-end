...
4. **Time Formatting:** Replaced 24-hour military times inside the [ItineraryDetails](file:///c:/Users/abdiaziz/OneDrive/Documents/new/myAgency-frontend-main/src/components/ticket/ItineraryDetails.jsx#5-98) ticket panel with clean, readable 12-hour AM/PM formats via a new [formatTimeToAMPM](file:///c:/Users/abdiaziz/OneDrive/Documents/new/myAgency-frontend-main/src/utils/ticketUtils.js#44-69) utility that cleanly extracts string format time and avoids local Javascript timezone mapping errors.

![Verified Ticket View With Exact Flight Timestamps in AM/PM Format](file:///C:/Users/abdiaziz/.gemini/antigravity/brain/9fbe57c5-af0e-496c-a264-12174c5d9656/ticket_itinerary_fixed_times_1773707569332.png)
